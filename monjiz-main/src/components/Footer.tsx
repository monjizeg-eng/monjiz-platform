...
export function Footer() {
  return (
    <footer className="border-t border-primary bg-primary text-primary-foreground mt-24">
      <div className="container-mz py-10 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
